...
- Changelog: march???-2024: A bunch of updates. 
...
- - Thinned the walls on the built in supports for the picatinny rails. Used to be 1mm wide, now 0.5mm wide. ~~ untested~~
- - ~~Tightened the picatinny keepers for the pump grip and the Skeggox stock (upon recommendation from OOD). ~~ untested
...
- - Extended the sear spring a little bit more via a new grip print. Should improve catch reliability. 
...
- - Moved the back spring rest in the PTback backward a few mm to improve catching with slightly oversized springs.
