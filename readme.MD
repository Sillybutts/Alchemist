...
- - Updated the sear and the plunger rod to be more wear-resistant and smoother to prime. Both these parts can be installed in existing Alchemists, you just need to take off the stock and install the sear from behind the PTback.
...
- - Tightened the picatinny keepers for the pump grip and the Skeggox stock. 
- - Lengthened the Skeggox picatinny rail a HAIR to fix a tolerance.
